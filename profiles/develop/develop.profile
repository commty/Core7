...
/**
 * @file
 * Enables modules and site configuration for a develop site installation.
 */
 ...
 */
function develop_form_install_configure_form_alter(&$form, $form_state) {
...
function develop_install_tasks_alter(&$tasks, $install_state){
