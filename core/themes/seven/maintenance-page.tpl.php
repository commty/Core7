  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-3 col-md-3 sidebar">
          <?php if ($logo): ?>
            <img id="logo" src="<?php print $logo ?>" alt="<?php print $site_name ?>" title="Логотип такой кривой, потому что нет дизайнера который его красиво нарисует :(" />
          <?php endif; ?>
      ...
      <div class="modal-dialog">
          <div class="modal-content">
              ...
              <div class="modal-body">
                 Господа контрибуторы, просьба написать исчерпывающую инструкцию по установке движка с картинками.
              </div>
